 ...
 * complete}
 */
public class CustomViewPagerAdapterV6 extends PagerAdapter {
	...
	public CustomViewPagerAdapterV6(FragmentManager fm, boolean useContacts) {
		mFragmentManager = fm;
	...
	public int getItemPosition(Object object) {
		...
		int index = mFragments.indexOf(f);
		if (index == -1)
	...
	@Override
	public int getCount() {
		return mContactItems.size() + (useContacts ? 1 : 0);
	}
}