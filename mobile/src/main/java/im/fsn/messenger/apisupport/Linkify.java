...
public class Linkify {
	...
	public static final void gatherLinks(ArrayList<LinkSpec> links,
	...
	public static final void gatherMapLinks(ArrayList<LinkSpec> links,
			Spannable s) {
	...
	public static final void pruneOverlaps(ArrayList<LinkSpec> links) {
