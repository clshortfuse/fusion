 ...
 * complete}
 */
public class CustomViewPagerAdapterV5 extends PagerAdapter {
	...
	private boolean openEditTextImmediately = false;

	public CustomViewPagerAdapterV5(FragmentManager fm, boolean useContacts) {
		mFragmentManager = fm;
	...
	public Fragment getItemIfExists(int position) {
	...
	public Fragment getItem(int position) {
		...
		if (useContacts) {
			...
			f = ConversationFragment.newInstance(mContactItems.get(position),
					position, position == 0 ? openEditTextImmediately : false,
					true);
		}
	...
	public boolean isOpenEditTextImmediately() {
		return openEditTextImmediately;
	}

	public void setOpenEditTextImmediately(boolean openEditTextImmediately) {
		this.openEditTextImmediately = openEditTextImmediately;
	}
}